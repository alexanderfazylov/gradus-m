<div id="main">
  ...
  <div id="equipment">
    ...
    <ul id="vendors">
      <li>
        <a href="#" class="vendor" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-viessmann.png');"><span style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-viessmann.png');"></span></a>
      </li>
      <li>
        <a href="#" class="vendor" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-vaillant.png');"><span style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-vaillant.png');"></span></a>
      </li>
      <li>
        <a href="#" class="vendor" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-buderus.png');"><span style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-buderus.png');"></span></a>
      </li>
      <li>
        <a href="#" class="vendor" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-uponor.png');"><span style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-uponor.png');"></span></a>
      </li>
      <li>
        <a href="#" class="vendor" style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-purmo.png');"><span style="background-image: url('<?php echo Yii::app()->request->baseUrl; ?>/img/equipment-purmo.png');"></span></a>
      </li>
    </ul>
  </div>
</div>